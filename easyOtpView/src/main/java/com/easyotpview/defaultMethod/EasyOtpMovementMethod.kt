package com.easyotpview.defaultMethod
 ...
 * view positions.
 */
internal class EasyOtpMovementMethod internal constructor() : MovementMethod {
     ...
     * */
    companion object {
        private var sInstance: EasyOtpMovementMethod? = null
        val instance: MovementMethod?
            get() {
                if (sInstance == null) {
                    sInstance = EasyOtpMovementMethod()
                }
                return sInstance
            }
    }
